...
import com.griga.composition.databinding.FragmentWelcomeBinding
...
class WelcomeFragment : Fragment() {
    ...
    private fun launchChooseLevelFragment() {
        val chooseLevelFragment = ChooseLevelFragment.getNewInstance()
    ...
    companion object {
        fun getNewInstance(): WelcomeFragment {
